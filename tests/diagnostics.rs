...
fn missing_semicolon_points_at_next_token() {
    let (line, col, msg) = error_for("function main()\n{\n    int x = 42\n    println(\"{}\", x);\n}\n");
...
fn bad_top_level_item_names_the_alternatives() {
    let (line, col, msg) = error_for("functoin main()\n{\n}\n");
